# -*- coding: utf-8 -*-
#
# Gisquick documentation build configuration file, created by
...
project = u'Gisquick'
copyright = u'2016-2022, Gisquick team'
...
man_pages = [
    ('index', 'gisquick', u'Gisquick Documentation',
     [u'Gisquick team'], 1)
]
